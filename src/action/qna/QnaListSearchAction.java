...
public class QnaListSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listCount = boardListService.getListCount(option,keyword); // 총 게시물 목록 수 가져오기

		articleList = boardListService.getArticleList(page, limit, option, keyword); // 게시물 목록 가져오기(페이지 번호에 해당하는 목록을 limit 개수만큼 가져오기)
		...
		forward.setPath("/center/qna/qna_List.jsp");
		return forward;
	}
